...
{
    const aboutMeTexts = ["Javascript Developer","React Developer","Frontend Developer"]; // Add more texts as needed
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    toggleButtons.forEach(button => {
        button.addEventListener('click', function() {
            const details = this.previousElementSibling; // Get the internship details (ul)
